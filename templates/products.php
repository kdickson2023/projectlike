        ...
        <form id="product_form" onsubmit="return false">
          ...
          <div class="form-group">            
            ...
            <div class="form-group col-md-6">
              ...
              <input type="tex" class="form-control" name="product_cost" id="product_cost" placeholder="Enter Product Cost" required/>
              </div>
          ...
          <div class="form-group">            
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" class="form-control" name="pro_date" id="pro_date" placeholder="Enter Production date" required/>
              </div>
