...
<head>
  ...
  <script type="text/javascript" src="./js/order5.js"></script>
 </head>
<body>
        ...
        <div class="card" style="box-shadow:0 0 25px 0 lightgrey;">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-3">
              ...
              <select class="form-control cid" id="cust_name" name="cust_name" />          
            </select>
            </div>
            <div class="form-group col-md-3">
              <label>Contact</label>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row col-sm-4">
                      <input type="submit" id="order_form" name ="order_form" style="width:150px;" class="btn btn-info" value="Order" align="center">
